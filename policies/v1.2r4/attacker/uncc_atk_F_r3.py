...
def strategy(state):
    ...
    for enemy in enemies.keys():
        enemy_name.append(enemy)
        enemy_pos.append(enemies[enemy])
    ...
    if current_pos is not _get_cache_Vsense(team_cache):
        ...
        if red_payoff > blue_payoff:
            ...
            if len(attacter_1_hop & Vtag_set) != 0:
               ...
               if len(option_nodes) != 0:
                  ...
                  best_node = random.choice(list(attacter_1_hop))
               min_node = best_node
    ...
    if current_pos in Vdef_not_Vgreen:
        ...
        if len(option_node_for_attacker) != 0:
            ...
            option_node_2 = Vteam_1_hop - Vtag_set
