...
def _eval_subtree(args):
    ...
    if len(surviving_def) +len(surviving_att) > 8:
        ...
        n_closest_defender = 3
    atk_names, def_names, att_acts, def_acts = rollout_policy_combined_better((surviving_att, surviving_def), n_nodes,neighbors_cache, sp_cache, real_flags,2, 2, n_closest_defender)
