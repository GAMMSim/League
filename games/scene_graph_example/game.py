...
from scene_graph_loader import get_places_graph_from_dsg
...
def main():
    ...
    try:
        ...
        G = get_places_graph_from_dsg(cfg.SCENE_GRAPH_PATH)
        ## Put code for checking agent/flag config vis-a-vis the graph
        ctx = initialize_game_context_wGraph(cfg.VISUALIZATION_ENGINE,G)
